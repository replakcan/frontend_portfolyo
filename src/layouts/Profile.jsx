...
const Profile = () => {
  ...
  return (
    <section className=" profile-section dark:bg-slate-800 dark:text-slate-300">
      <h1 className="profile-title text-limon dark:text-gray-300 font-bold">{data.profile.main_title}</h1>
      <div className="profile-container dark:text-slate-300">
        <div className="info-container profile-child leading-10 dark:text-slate-300">
          <h2 className="info-heading pb-3 text-3xl text-white dark:text-slate-300">{data.profile.sub_title[0]}</h2>
        ...
        <img className="profile-child profile-img rounded-3xl h-max w-fit" src="./images/hero/alper.png" />
        <div className="info-content profile-child">
          <h2 className="aboutMe-heading pb-3 text-3xl text-white dark:text-slate-300 ">{data.profile.sub_title[1]}</h2>
